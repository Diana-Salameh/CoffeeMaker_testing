...
public class CoffeeMaker {
	 ...
	 */
	public boolean addRecipe(Recipe r) throws RecipeException {
	 ...
	 */
	public String editRecipe(int recipeToEdit, Recipe r) throws NumberFormatException, RecipeException {
